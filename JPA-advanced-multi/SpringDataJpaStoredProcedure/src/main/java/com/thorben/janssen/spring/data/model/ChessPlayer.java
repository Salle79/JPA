...
@Entity
@NamedStoredProcedureQuery(name = "named.calculate",
                           procedureName = "calculate",
                           parameters = {@StoredProcedureParameter(name = "x", mode = ParameterMode.IN, type = Double.class),
                                         @StoredProcedureParameter(name = "y", mode = ParameterMode.IN, type = Double.class),
                                         @StoredProcedureParameter(name = "sum", mode = ParameterMode.OUT, type = Double.class)})
