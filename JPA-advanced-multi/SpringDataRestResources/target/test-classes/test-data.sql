TRUNCATE Chess_Player CASCADE;
TRUNCATE Chess_Tournament CASCADE;
TRUNCATE Chess_Game CASCADE;
...
INSERT INTO Chess_Player(id, birth_date, first_name, last_name, version) VALUES (5, '1998-04-26', 'Jan-Krzysztof', 'Duda', 0);
