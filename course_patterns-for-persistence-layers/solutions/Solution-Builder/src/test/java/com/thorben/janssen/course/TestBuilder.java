...
import com.thorben.janssen.course.model.builder.PurchaseOrderBuilder;
...
public class TestBuilder {
	...
	public void exercise3() {
        ...
        PurchaseOrder order = new PurchaseOrderBuilder().withCustomer("My Customer")
                                                        .withOrderDate(LocalDate.now())
                                                        .withPurchaseOrderItems().addItem()
                                                                                    .withProductName("Hibernate Tips ebook")
                                                                                    .withQuantity(1)
                                                                                    .addToList()
                                                                                 .addItem()
                                                                                    .withProductName("Persistence Hub membership")
                                                                                    .withQuantity(1)
                                                                                    .addToList()
                                                                                 .addItem()
                                                                                    .withProductName("Persistence Hub membership")
